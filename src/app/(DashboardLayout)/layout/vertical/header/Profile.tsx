...
const Profile = () => {
  ...
  return (
    <Box>
      ...
      >
        <Avatar
          src={"/images/profile/palmerluckey.png"}
          alt={"ProfileImg"}
          sx={{
            width: 45,
            height: 45,
        ...
        {lgUp ? <Box textAlign="left">
          <Typography variant="h6" color="textPrimary" display="flex" alignItems="center">Palmer Luckey</Typography>
          <Typography variant="subtitle2" color="textSecondary">Anduril CEO</Typography>
        </Box> : ""}
      </Button>
      {/* ------------------------------------------- */}
      {/* Message Dropdown */}
